...
public class WorldGenVillagePieces {
    ...
    public static void a() {
        WorldGenFactory.a(WorldGenVillagePieces.a.class, "ViBH");
        WorldGenFactory.a(WorldGenVillagePieces.b.class, "ViDF");
        WorldGenFactory.a(WorldGenVillagePieces.c.class, "ViF");
        WorldGenFactory.a(WorldGenVillagePieces.d.class, "ViL");
        WorldGenFactory.a(WorldGenVillagePieces.f.class, "ViPH");
        WorldGenFactory.a(WorldGenVillagePieces.g.class, "ViSH");
        WorldGenFactory.a(WorldGenVillagePieces.h.class, "ViSmH");
        WorldGenFactory.a(WorldGenVillagePieces.i.class, "ViST");
        WorldGenFactory.a(WorldGenVillagePieces.j.class, "ViS");
        WorldGenFactory.a(WorldGenVillagePieces.k.class, "ViStart");
        WorldGenFactory.a(WorldGenVillagePieces.l.class, "ViSR");
        WorldGenFactory.a(WorldGenVillagePieces.m.class, "ViTRH");
        WorldGenFactory.a(WorldGenVillagePieces.p.class, "ViW");
    }

    public static List<WorldGenVillagePieces.e> a(Random random, int i) {
        ArrayList arraylist = Lists.newArrayList();

        arraylist.add(new WorldGenVillagePieces.e(WorldGenVillagePieces.g.class, 4, MathHelper.nextInt(random, 2 + i, 4 + i * 2)));
        arraylist.add(new WorldGenVillagePieces.e(WorldGenVillagePieces.i.class, 20, MathHelper.nextInt(random, 0 + i, 1 + i)));
        arraylist.add(new WorldGenVillagePieces.e(WorldGenVillagePieces.a.class, 20, MathHelper.nextInt(random, 0 + i, 2 + i)));
        arraylist.add(new WorldGenVillagePieces.e(WorldGenVillagePieces.h.class, 3, MathHelper.nextInt(random, 2 + i, 5 + i * 3)));
        arraylist.add(new WorldGenVillagePieces.e(WorldGenVillagePieces.f.class, 15, MathHelper.nextInt(random, 0 + i, 2 + i)));
        arraylist.add(new WorldGenVillagePieces.e(WorldGenVillagePieces.b.class, 3, MathHelper.nextInt(random, 1 + i, 4 + i)));
        arraylist.add(new WorldGenVillagePieces.e(WorldGenVillagePieces.c.class, 3, MathHelper.nextInt(random, 2 + i, 4 + i * 2)));
        arraylist.add(new WorldGenVillagePieces.e(WorldGenVillagePieces.j.class, 15, MathHelper.nextInt(random, 0, 1 + i)));
        arraylist.add(new WorldGenVillagePieces.e(WorldGenVillagePieces.m.class, 8, MathHelper.nextInt(random, 0 + i, 3 + i * 2)));
        Iterator iterator = arraylist.iterator();

        while (iterator.hasNext()) {
            if (((WorldGenVillagePieces.e) iterator.next()).d == 0) {
                iterator.remove();
            }
        }
    ...
    private static int a(List<WorldGenVillagePieces.e> list) {
        boolean flag = false;
        int i = 0;

        WorldGenVillagePieces.e worldgenvillagepieces_e;

        for (Iterator iterator = list.iterator(); iterator.hasNext(); i += worldgenvillagepieces_e.b) {
            worldgenvillagepieces_e = (WorldGenVillagePieces.e) iterator.next();
            if (worldgenvillagepieces_e.d > 0 && worldgenvillagepieces_e.c < worldgenvillagepieces_e.d) {
                flag = true;
            }
        }
    ...
    private static WorldGenVillagePieces.n a(WorldGenVillagePieces.k worldgenvillagepieces_k, WorldGenVillagePieces.e worldgenvillagepieces_e, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        Class oclass = worldgenvillagepieces_e.a;
        Object object = null;

        if (oclass == WorldGenVillagePieces.g.class) {
            object = WorldGenVillagePieces.g.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l);
        } else if (oclass == WorldGenVillagePieces.i.class) {
            object = WorldGenVillagePieces.i.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l);
        } else if (oclass == WorldGenVillagePieces.a.class) {
            object = WorldGenVillagePieces.a.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l);
        } else if (oclass == WorldGenVillagePieces.h.class) {
            object = WorldGenVillagePieces.h.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l);
        } else if (oclass == WorldGenVillagePieces.f.class) {
            object = WorldGenVillagePieces.f.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l);
        } else if (oclass == WorldGenVillagePieces.b.class) {
            object = WorldGenVillagePieces.b.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l);
        } else if (oclass == WorldGenVillagePieces.c.class) {
            object = WorldGenVillagePieces.c.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l);
        } else if (oclass == WorldGenVillagePieces.j.class) {
            object = WorldGenVillagePieces.j.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l);
        } else if (oclass == WorldGenVillagePieces.m.class) {
            object = WorldGenVillagePieces.m.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l);
        }

        return (WorldGenVillagePieces.n) object;
    }

    private static WorldGenVillagePieces.n c(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        int i1 = a(worldgenvillagepieces_k.e);
        ...
        if (i1 <= 0) {
            ...
            while (j1 < 5) {
                ...
                Iterator iterator = worldgenvillagepieces_k.e.iterator();

                while (iterator.hasNext()) {
                    WorldGenVillagePieces.e worldgenvillagepieces_e = (WorldGenVillagePieces.e) iterator.next();

                    k1 -= worldgenvillagepieces_e.b;
                    if (k1 < 0) {
                        if (!worldgenvillagepieces_e.a(l) || worldgenvillagepieces_e == worldgenvillagepieces_k.d && worldgenvillagepieces_k.e.size() > 1) {
                            break;
                        }

                        WorldGenVillagePieces.n worldgenvillagepieces_n = a(worldgenvillagepieces_k, worldgenvillagepieces_e, list, random, i, j, k, enumdirection, l);

                        if (worldgenvillagepieces_n != null) {
                            ++worldgenvillagepieces_e.c;
                            worldgenvillagepieces_k.d = worldgenvillagepieces_e;
                            if (!worldgenvillagepieces_e.a()) {
                                worldgenvillagepieces_k.e.remove(worldgenvillagepieces_e);
                            }

                            return worldgenvillagepieces_n;
                        }
                    }
                }
            }

            StructureBoundingBox structureboundingbox = WorldGenVillagePieces.d.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection);

            if (structureboundingbox != null) {
                return new WorldGenVillagePieces.d(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection);
            } else {
                return null;
            }
        }
    ...
    private static StructurePiece d(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        if (l > 50) {
            return null;
        } else if (Math.abs(i - worldgenvillagepieces_k.c().a) <= 112 && Math.abs(k - worldgenvillagepieces_k.c().c) <= 112) {
            WorldGenVillagePieces.n worldgenvillagepieces_n = c(worldgenvillagepieces_k, list, random, i, j, k, enumdirection, l + 1);

            if (worldgenvillagepieces_n != null) {
                int i1 = (worldgenvillagepieces_n.l.a + worldgenvillagepieces_n.l.d) / 2;
                int j1 = (worldgenvillagepieces_n.l.c + worldgenvillagepieces_n.l.f) / 2;
                int k1 = worldgenvillagepieces_n.l.d - worldgenvillagepieces_n.l.a;
                int l1 = worldgenvillagepieces_n.l.f - worldgenvillagepieces_n.l.c;
                int i2 = k1 > l1 ? k1 : l1;

                if (worldgenvillagepieces_k.e().a(i1, j1, i2 / 2 + 4, WorldGenVillage.d)) {
                    list.add(worldgenvillagepieces_n);
                    worldgenvillagepieces_k.f.add(worldgenvillagepieces_n);
                    return worldgenvillagepieces_n;
                }
            }
    ...
    private static StructurePiece e(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        if (l > 3 + worldgenvillagepieces_k.c) {
            return null;
        } else if (Math.abs(i - worldgenvillagepieces_k.c().a) <= 112 && Math.abs(k - worldgenvillagepieces_k.c().c) <= 112) {
            StructureBoundingBox structureboundingbox = WorldGenVillagePieces.l.a(worldgenvillagepieces_k, list, random, i, j, k, enumdirection);

            if (structureboundingbox != null && structureboundingbox.b > 10) {
                WorldGenVillagePieces.l worldgenvillagepieces_l = new WorldGenVillagePieces.l(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection);
                int i1 = (worldgenvillagepieces_l.l.a + worldgenvillagepieces_l.l.d) / 2;
                int j1 = (worldgenvillagepieces_l.l.c + worldgenvillagepieces_l.l.f) / 2;
                int k1 = worldgenvillagepieces_l.l.d - worldgenvillagepieces_l.l.a;
                int l1 = worldgenvillagepieces_l.l.f - worldgenvillagepieces_l.l.c;
                int i2 = k1 > l1 ? k1 : l1;

                if (worldgenvillagepieces_k.e().a(i1, j1, i2 / 2 + 4, WorldGenVillage.d)) {
                    list.add(worldgenvillagepieces_l);
                    worldgenvillagepieces_k.g.add(worldgenvillagepieces_l);
                    return worldgenvillagepieces_l;
                }
            }
    ...
    public static class d extends WorldGenVillagePieces.n {

        public d() {}

        public d(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
        }

        public static StructureBoundingBox a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection) {
    ...
    public static class b extends WorldGenVillagePieces.n {
        ...
        public b(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
        ...
        public static WorldGenVillagePieces.b a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, 0, 0, 0, 13, 4, 9, enumdirection);

            return a(structureboundingbox) && StructurePiece.a(list, structureboundingbox) == null ? new WorldGenVillagePieces.b(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection) : null;
        }
    ...
    public static class c extends WorldGenVillagePieces.n {
        ...
        public c(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
            this.a = this.a(random);
        ...
        public static WorldGenVillagePieces.c a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, 0, 0, 0, 7, 4, 9, enumdirection);

            return a(structureboundingbox) && StructurePiece.a(list, structureboundingbox) == null ? new WorldGenVillagePieces.c(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection) : null;
        }
    ...
    public static class j extends WorldGenVillagePieces.n {
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            ...
            if (!this.b && structureboundingbox.b((BaseBlockPosition) (new BlockPosition(this.a(5, 5), this.d(1), this.b(5, 5))))) {
                this.b = true;
                this.a(world, structureboundingbox, random, 5, 1, 5, WorldGenVillagePieces.j.a, 3 + random.nextInt(6));
            }
    ...
    public static class m extends WorldGenVillagePieces.n {

        public m() {}

        public m(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
        }

        public static WorldGenVillagePieces.m a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, 0, 0, 0, 9, 7, 12, enumdirection);

            return a(structureboundingbox) && StructurePiece.a(list, structureboundingbox) == null ? new WorldGenVillagePieces.m(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection) : null;
        }
    ...
    public static class f extends WorldGenVillagePieces.n {

        public f() {}

        public f(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
        }

        public static WorldGenVillagePieces.f a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, 0, 0, 0, 9, 7, 11, enumdirection);

            return a(structureboundingbox) && StructurePiece.a(list, structureboundingbox) == null ? new WorldGenVillagePieces.f(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection) : null;
        }
    ...
    public static class h extends WorldGenVillagePieces.n {
        ...
        public h(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
        ...
        public static WorldGenVillagePieces.h a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, 0, 0, 0, 4, 6, 5, enumdirection);

            return a(structureboundingbox) && StructurePiece.a(list, structureboundingbox) == null ? new WorldGenVillagePieces.h(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection) : null;
        }
    ...
    public static class a extends WorldGenVillagePieces.n {

        public a() {}

        public a(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
        }

        public static WorldGenVillagePieces.a a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, 0, 0, 0, 9, 9, 6, enumdirection);

            return a(structureboundingbox) && StructurePiece.a(list, structureboundingbox) == null ? new WorldGenVillagePieces.a(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection) : null;
        }
    ...
    public static class i extends WorldGenVillagePieces.n {

        public i() {}

        public i(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
        }

        public static WorldGenVillagePieces.i a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, 0, 0, 0, 5, 12, 9, enumdirection);

            return a(structureboundingbox) && StructurePiece.a(list, structureboundingbox) == null ? new WorldGenVillagePieces.i(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection) : null;
        }
    ...
    public static class g extends WorldGenVillagePieces.n {

        private boolean a;

        public g() {}

        public g(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
            this.a = random.nextBoolean();
        ...
        public static WorldGenVillagePieces.g a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.a(i, j, k, 0, 0, 0, 5, 6, 5, enumdirection);

            return StructurePiece.a(list, structureboundingbox) != null ? null : new WorldGenVillagePieces.g(worldgenvillagepieces_k, l, random, structureboundingbox, enumdirection);
        }
    ...
    public static class l extends WorldGenVillagePieces.o {

        private int a;

        public l() {}

        public l(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(worldgenvillagepieces_k, i);
            this.m = enumdirection;
            this.l = structureboundingbox;
        ...
        public void a(StructurePiece structurepiece, List<StructurePiece> list, Random random) {
            ...
            for (i = random.nextInt(5); i < this.a - 8; i += 2 + random.nextInt(5)) {
                structurepiece1 = this.a((WorldGenVillagePieces.k) structurepiece, list, random, 0, i);
            ...
            for (i = random.nextInt(5); i < this.a - 8; i += 2 + random.nextInt(5)) {
                structurepiece1 = this.b((WorldGenVillagePieces.k) structurepiece, list, random, 0, i);
                if (structurepiece1 != null) {
                    i += Math.max(structurepiece1.l.c(), structurepiece1.l.e());
                    flag = true;
                }
            ...
            if (flag && random.nextInt(3) > 0 && this.m != null) {
                ...
                case 1:
                    WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.a - 1, this.l.b, this.l.c, EnumDirection.WEST, this.d());
                    break;

                case 2:
                    WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.a - 1, this.l.b, this.l.f - 2, EnumDirection.WEST, this.d());
                    break;

                case 3:
                    WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.a, this.l.b, this.l.c - 1, EnumDirection.NORTH, this.d());
                    break;

                case 4:
                    WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.d - 2, this.l.b, this.l.c - 1, EnumDirection.NORTH, this.d());
                }
            }
            ...
            if (flag && random.nextInt(3) > 0 && this.m != null) {
                switch (WorldGenVillagePieces.SyntheticClass_1.a[this.m.ordinal()]) {
                case 1:
                    WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.d + 1, this.l.b, this.l.c, EnumDirection.EAST, this.d());
                    break;

                case 2:
                    WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.d + 1, this.l.b, this.l.f - 2, EnumDirection.EAST, this.d());
                    break;

                case 3:
                    WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.a, this.l.b, this.l.f + 1, EnumDirection.SOUTH, this.d());
                    break;

                case 4:
                    WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.d - 2, this.l.b, this.l.f + 1, EnumDirection.SOUTH, this.d());
                }
            }
    ...
    public abstract static class o extends WorldGenVillagePieces.n {

        public o() {}

        protected o(WorldGenVillagePieces.k worldgenvillagepieces_k, int i) {
            super(worldgenvillagepieces_k, i);
        }
    }

    public static class k extends WorldGenVillagePieces.p {

        public WorldChunkManager a;
        public boolean b;
        public int c;
        public WorldGenVillagePieces.e d;
        public List<WorldGenVillagePieces.e> e;
        public List<StructurePiece> f = Lists.newArrayList();
        public List<StructurePiece> g = Lists.newArrayList();

        public k() {}

        public k(WorldChunkManager worldchunkmanager, int i, Random random, int j, int k, List<WorldGenVillagePieces.e> list, int l) {
            super((WorldGenVillagePieces.k) null, 0, random, j, k);
    ...
    public static class p extends WorldGenVillagePieces.n {

        public p() {}

        public p(WorldGenVillagePieces.k worldgenvillagepieces_k, int i, Random random, int j, int k) {
            super(worldgenvillagepieces_k, i);
        ...
        public void a(StructurePiece structurepiece, List<StructurePiece> list, Random random) {
            WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.a - 1, this.l.e - 4, this.l.c + 1, EnumDirection.WEST, this.d());
            WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.d + 1, this.l.e - 4, this.l.c + 1, EnumDirection.EAST, this.d());
            WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.a + 1, this.l.e - 4, this.l.c - 1, EnumDirection.NORTH, this.d());
            WorldGenVillagePieces.e((WorldGenVillagePieces.k) structurepiece, list, random, this.l.a + 1, this.l.e - 4, this.l.f + 1, EnumDirection.SOUTH, this.d());
        }
    ...
    abstract static class n extends StructurePiece {
        ...
        protected n(WorldGenVillagePieces.k worldgenvillagepieces_k, int i) {
            super(i);
            if (worldgenvillagepieces_k != null) {
                this.b = worldgenvillagepieces_k.b;
            }
        ...
        protected StructurePiece a(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j) {
            if (this.m != null) {
                switch (WorldGenVillagePieces.SyntheticClass_1.a[this.m.ordinal()]) {
                case 1:
                    return WorldGenVillagePieces.d(worldgenvillagepieces_k, list, random, this.l.a - 1, this.l.b + i, this.l.c + j, EnumDirection.WEST, this.d());

                case 2:
                    return WorldGenVillagePieces.d(worldgenvillagepieces_k, list, random, this.l.a - 1, this.l.b + i, this.l.c + j, EnumDirection.WEST, this.d());

                case 3:
                    return WorldGenVillagePieces.d(worldgenvillagepieces_k, list, random, this.l.a + j, this.l.b + i, this.l.c - 1, EnumDirection.NORTH, this.d());
        ...
        protected StructurePiece b(WorldGenVillagePieces.k worldgenvillagepieces_k, List<StructurePiece> list, Random random, int i, int j) {
            if (this.m != null) {
                switch (WorldGenVillagePieces.SyntheticClass_1.a[this.m.ordinal()]) {
                case 1:
                    return WorldGenVillagePieces.d(worldgenvillagepieces_k, list, random, this.l.d + 1, this.l.b + i, this.l.c + j, EnumDirection.EAST, this.d());

                case 2:
                    return WorldGenVillagePieces.d(worldgenvillagepieces_k, list, random, this.l.d + 1, this.l.b + i, this.l.c + j, EnumDirection.EAST, this.d());

                case 3:
                    return WorldGenVillagePieces.d(worldgenvillagepieces_k, list, random, this.l.a + j, this.l.b + i, this.l.f + 1, EnumDirection.SOUTH, this.d());
        ...
        protected int b(World world, StructureBoundingBox structureboundingbox) {
            ...
            for (int k = this.l.c; k <= this.l.f; ++k) {
                for (int l = this.l.a; l <= this.l.d; ++l) {
                    blockposition_a.c(l, 64, k);
                    if (structureboundingbox.b((BaseBlockPosition) blockposition_a)) {
                        i += Math.max(world.r(blockposition_a).getY(), world.worldProvider.getSeaLevel());
                        ++j;
                    }
                }
            }
        ...
        protected IBlockData a(IBlockData iblockdata) {
            if (this.b) {
                ...
                if (iblockdata.getBlock() == Blocks.COBBLESTONE) {
                    return Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.DEFAULT.a());
                }

                if (iblockdata.getBlock() == Blocks.PLANKS) {
                    return Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a());
                }
    ...
    public static class e {
        ...
        public Class<? extends WorldGenVillagePieces.n> a;
        public final int b;
        public int c;
        public int d;

        public e(Class<? extends WorldGenVillagePieces.n> oclass, int i, int j) {
            this.a = oclass;
            this.b = i;
            this.d = j;
        }

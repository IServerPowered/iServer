...
public class WorldGenRegistration {
    ...
    public static void a() {
        WorldGenFactory.a(WorldGenRegistration.a.class, "TeDP");
        WorldGenFactory.a(WorldGenRegistration.b.class, "TeJP");
        WorldGenFactory.a(WorldGenRegistration.d.class, "TeSH");
    }
    ...
    public static class d extends WorldGenRegistration.c {

        private boolean e;

        public d() {}

        public d(Random random, int i, int j) {
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            if (!this.a(world, structureboundingbox, 0)) {
                ...
                this.a(world, structureboundingbox, 1, 1, 1, 5, 1, 7, Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), false);
                this.a(world, structureboundingbox, 1, 4, 2, 5, 4, 7, Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), false);
                this.a(world, structureboundingbox, 2, 1, 0, 4, 1, 0, Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), false);
                this.a(world, structureboundingbox, 2, 2, 2, 3, 3, 2, Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), false);
                this.a(world, structureboundingbox, 1, 2, 3, 1, 3, 6, Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), false);
                this.a(world, structureboundingbox, 5, 2, 3, 5, 3, 6, Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), false);
                this.a(world, structureboundingbox, 2, 2, 7, 4, 3, 7, Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), Blocks.PLANKS.fromLegacyData(BlockWood.a.SPRUCE.a()), false);
                ...
                this.a(world, Blocks.FLOWER_POT.getBlockData().set(BlockFlowerPot.CONTENTS, BlockFlowerPot.a.MUSHROOM_RED), 1, 3, 5, structureboundingbox);
    ...
    public static class b extends WorldGenRegistration.c {
        ...
        private static WorldGenRegistration.b.a k = new WorldGenRegistration.b.a((WorldGenRegistration.SyntheticClass_1) null);
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            if (!this.a(world, structureboundingbox, 0)) {
                ...
                this.a(world, structureboundingbox, 0, -4, 0, this.a - 1, 0, this.c - 1, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 2, 1, 2, 9, 2, 2, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 2, 1, 12, 9, 2, 12, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 2, 1, 3, 2, 2, 11, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 9, 1, 3, 9, 2, 11, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 1, 3, 1, 10, 6, 1, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 1, 3, 13, 10, 6, 13, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 1, 3, 2, 1, 6, 12, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 10, 3, 2, 10, 6, 12, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 2, 3, 2, 9, 3, 12, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 2, 6, 2, 9, 6, 12, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 3, 7, 3, 8, 7, 11, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 4, 8, 4, 7, 8, 10, false, random, WorldGenRegistration.b.k);
                ...
                for (i1 = 0; i1 <= 14; i1 += 14) {
                    this.a(world, structureboundingbox, 2, 4, i1, 2, 5, i1, false, random, WorldGenRegistration.b.k);
                    this.a(world, structureboundingbox, 4, 4, i1, 4, 5, i1, false, random, WorldGenRegistration.b.k);
                    this.a(world, structureboundingbox, 7, 4, i1, 7, 5, i1, false, random, WorldGenRegistration.b.k);
                    this.a(world, structureboundingbox, 9, 4, i1, 9, 5, i1, false, random, WorldGenRegistration.b.k);
                }

                this.a(world, structureboundingbox, 5, 6, 0, 6, 6, 0, false, random, WorldGenRegistration.b.k);

                for (i1 = 0; i1 <= 11; i1 += 11) {
                    for (int j1 = 2; j1 <= 12; j1 += 2) {
                        this.a(world, structureboundingbox, i1, 4, j1, i1, 5, j1, false, random, WorldGenRegistration.b.k);
                    }

                    this.a(world, structureboundingbox, i1, 6, 5, i1, 6, 5, false, random, WorldGenRegistration.b.k);
                    this.a(world, structureboundingbox, i1, 6, 9, i1, 6, 9, false, random, WorldGenRegistration.b.k);
                }

                this.a(world, structureboundingbox, 2, 7, 2, 2, 9, 2, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 9, 7, 2, 9, 9, 2, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 2, 7, 12, 2, 9, 12, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 9, 7, 12, 9, 9, 12, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 4, 9, 4, 4, 9, 4, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 7, 9, 4, 7, 9, 4, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 4, 9, 10, 4, 9, 10, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 7, 9, 10, 7, 9, 10, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 5, 9, 7, 6, 9, 7, false, random, WorldGenRegistration.b.k);
                ...
                this.a(world, structureboundingbox, 4, 1, 9, 4, 1, 9, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 7, 1, 9, 7, 1, 9, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 4, 1, 10, 7, 2, 10, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 5, 4, 5, 6, 4, 5, false, random, WorldGenRegistration.b.k);
                ...
                for (i1 = 1; i1 <= 13; i1 += 2) {
                    this.a(world, structureboundingbox, 1, -3, i1, 1, -2, i1, false, random, WorldGenRegistration.b.k);
                }

                for (i1 = 2; i1 <= 12; i1 += 2) {
                    this.a(world, structureboundingbox, 1, -1, i1, 3, -1, i1, false, random, WorldGenRegistration.b.k);
                }

                this.a(world, structureboundingbox, 2, -2, 1, 5, -2, 1, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 7, -2, 1, 9, -2, 1, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 6, -3, 1, 6, -3, 1, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 6, -1, 1, 6, -1, 1, false, random, WorldGenRegistration.b.k);
                ...
                if (!this.g) {
                    this.g = this.a(world, structureboundingbox, random, 3, -2, 1, EnumDirection.NORTH.a(), WorldGenRegistration.b.j, 2);
                }
                ...
                if (!this.h) {
                    this.h = this.a(world, structureboundingbox, random, 9, -2, 3, EnumDirection.WEST.a(), WorldGenRegistration.b.j, 2);
                }
                ...
                if (!this.e) {
                    this.e = this.a(world, structureboundingbox, random, 8, -3, 3, StructurePieceTreasure.a(WorldGenRegistration.b.i, new StructurePieceTreasure[] { Items.ENCHANTED_BOOK.b(random)}), 2 + random.nextInt(5));
                }
                ...
                this.a(world, structureboundingbox, 9, -1, 1, 9, -1, 5, false, random, WorldGenRegistration.b.k);
                ...
                this.a(world, structureboundingbox, 8, -3, 8, 8, -3, 10, false, random, WorldGenRegistration.b.k);
                this.a(world, structureboundingbox, 10, -3, 8, 10, -3, 10, false, random, WorldGenRegistration.b.k);
                ...
                if (!this.f) {
                    this.f = this.a(world, structureboundingbox, random, 9, -3, 10, StructurePieceTreasure.a(WorldGenRegistration.b.i, new StructurePieceTreasure[] { Items.ENCHANTED_BOOK.b(random)}), 2 + random.nextInt(5));
                }
        ...
        static class a extends StructurePiece.a {
            ...
            a(WorldGenRegistration.SyntheticClass_1 worldgenregistration_syntheticclass_1) {
                this();
            }
        }
    }

    public static class a extends WorldGenRegistration.c {
        ...
        public a(Random random, int i, int j) {
        ...
        public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
            ...
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 9, 1, 1, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 9, 2, 1, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 9, 3, 1, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 10, 3, 1, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 11, 3, 1, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 11, 2, 1, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 11, 1, 1, structureboundingbox);
            ...
            this.a(world, structureboundingbox, 8, 1, 8, 8, 3, 8, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), false);
            this.a(world, structureboundingbox, 12, 1, 8, 12, 3, 8, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), false);
            this.a(world, structureboundingbox, 8, 1, 12, 8, 3, 12, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), false);
            this.a(world, structureboundingbox, 12, 1, 12, 12, 3, 12, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), false);
            ...
            this.a(world, structureboundingbox, 5, 5, 9, 5, 7, 11, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), false);
            this.a(world, structureboundingbox, this.a - 6, 5, 9, this.a - 6, 7, 11, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), false);
            ...
            this.a(world, Blocks.STONE_SLAB.fromLegacyData(BlockDoubleStepAbstract.a.SAND.a()), 1, 2, 2, structureboundingbox);
            this.a(world, Blocks.STONE_SLAB.fromLegacyData(BlockDoubleStepAbstract.a.SAND.a()), this.a - 2, 2, 2, structureboundingbox);
            ...
            for (k1 = 5; k1 <= 17; k1 += 2) {
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 4, 1, k1, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), 4, 2, k1, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), this.a - 5, 1, k1, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), this.a - 5, 2, k1, structureboundingbox);
            }
            ...
            for (k1 = 0; k1 <= this.a - 1; k1 += this.a - 1) {
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 2, 1, structureboundingbox);
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1, 2, 2, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 2, 3, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 3, 1, structureboundingbox);
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1, 3, 2, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 3, 3, structureboundingbox);
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1, 4, 1, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), k1, 4, 2, structureboundingbox);
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1, 4, 3, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 5, 1, structureboundingbox);
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1, 5, 2, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 5, 3, structureboundingbox);
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1, 6, 1, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), k1, 6, 2, structureboundingbox);
                ...
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 8, 1, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 8, 2, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 8, 3, structureboundingbox);
            }

            for (k1 = 2; k1 <= this.a - 3; k1 += this.a - 3 - 2) {
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1 - 1, 2, 0, structureboundingbox);
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1, 2, 0, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1 + 1, 2, 0, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1 - 1, 3, 0, structureboundingbox);
                ...
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), k1, 4, 0, structureboundingbox);
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1 + 1, 4, 0, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1 - 1, 5, 0, structureboundingbox);
                ...
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), k1, 6, 0, structureboundingbox);
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1 + 1, 6, 0, structureboundingbox);
                ...
                this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), k1 + 1, 7, 0, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1 - 1, 8, 0, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1, 8, 0, structureboundingbox);
                this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), k1 + 1, 8, 0, structureboundingbox);
            }

            this.a(world, structureboundingbox, 8, 4, 0, 12, 6, 0, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), false);
            ...
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), 10, 5, 0, structureboundingbox);
            this.a(world, Blocks.STAINED_HARDENED_CLAY.fromLegacyData(i1), 11, 5, 0, structureboundingbox);
            this.a(world, structureboundingbox, 8, -14, 8, 12, -11, 12, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), false);
            this.a(world, structureboundingbox, 8, -10, 8, 12, -10, 12, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), false);
            this.a(world, structureboundingbox, 8, -9, 8, 12, -9, 12, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), false);
            ...
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), 7, -10, 10, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 7, -11, 10, structureboundingbox);
            ...
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), 13, -10, 10, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 13, -11, 10, structureboundingbox);
            ...
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), 10, -10, 7, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 10, -11, 7, structureboundingbox);
            ...
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.CHISELED.a()), 10, -10, 13, structureboundingbox);
            this.a(world, Blocks.SANDSTONE.fromLegacyData(BlockSandStone.a.SMOOTH.a()), 10, -11, 13, structureboundingbox);
            ...
            while (iterator.hasNext()) {
                ...
                if (!this.e[enumdirection.b()]) {
                    ...
                    this.e[enumdirection.b()] = this.a(world, structureboundingbox, random, 10 + l1, -11, 10 + i2, StructurePieceTreasure.a(WorldGenRegistration.a.f, new StructurePieceTreasure[] { Items.ENCHANTED_BOOK.b(random)}), 2 + random.nextInt(5));
                }
            }
    ...
    abstract static class c extends StructurePiece {
        ...
        protected c(Random random, int i, int j, int k, int l, int i1, int j1) {
            super(0);
            this.a = l;
            this.b = i1;
            this.c = j1;
            ...
            if (this.d >= 0) {
                ...
                for (int l = this.l.c; l <= this.l.f; ++l) {
                    for (int i1 = this.l.a; i1 <= this.l.d; ++i1) {
                        blockposition_a.c(i1, 64, l);
                        if (structureboundingbox.b((BaseBlockPosition) blockposition_a)) {
                            j += Math.max(world.r(blockposition_a).getY(), world.worldProvider.getSeaLevel());
                            ++k;
                        }
                    }
                }

...
public abstract class MinecraftServer implements Runnable, ICommandListener, IAsyncTaskHandler, IMojangStatistics {
    ...
    public abstract WorldSettings.a getGamemode();
    ...
    public void run() {
        try {
            if (this.init()) {
                ...
                this.r.setServerInfo(new ServerPing.c("1.8.3", 47));
                this.a(this.r);
    ...
    protected void z() {
        ...
        if (i - this.X >= 5000000000L) {
            this.X = i;
            this.r.setPlayerSample(new ServerPing.a(this.I(), this.H()));
	...
	public void A() {
        ...
        synchronized (this.j) {
            while (!this.j.isEmpty()) {
                SystemUtils.a((FutureTask<Object>) this.j.poll(), MinecraftServer.LOGGER);
            }
        }
    ...
    public void setGamemode(WorldSettings.a worldsettings_a) {
        for (int i = 0; i < this.worldServer.length; ++i) {
            getServer().worldServer[i].getWorldData().setGameType(worldsettings_a);
        }
    ...
    public abstract String a(WorldSettings.a worldsettings_a, boolean flag);

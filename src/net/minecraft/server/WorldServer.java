...
public class WorldServer extends World implements IAsyncTaskHandler {
    ...
    private WorldServer.a[] S = new WorldServer.a[] { new WorldServer.a(null), new WorldServer.a(null)};
    private int T;
    ...
    public BiomeBase.c a(EnumCreatureType enumcreaturetype, BlockPosition blockposition) {
        List list = this.N().getMobsFor(enumcreaturetype, blockposition);

        return list != null && !list.isEmpty() ? (BiomeBase.c) WeightedRandom.a(this.random, list) : null;
    }

    public boolean a(EnumCreatureType enumcreaturetype, BiomeBase.c biomebase_c, BlockPosition blockposition) {
        List list = this.N().getMobsFor(enumcreaturetype, blockposition);

        return list != null && !list.isEmpty() ? list.contains(biomebase_c) : false;
    }
    ...
    private void aj() {
        ...
        this.worldData.setGameType(WorldSettings.a.SPECTATOR);
    ...
    public void save(boolean flag, IProgressUpdate iprogressupdate) throws ExceptionWorldConflict {
        if (this.chunkProvider.canSave()) {
            ...
            ArrayList arraylist = Lists.newArrayList((Iterable) this.chunkProviderServer.a());
    ...
    static class a extends ArrayList<BlockActionData> {
